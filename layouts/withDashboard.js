...
export const WithDashboard = ({ children }) => {
    ...
    <div className="flex h-screen bg-gray-200">
        <div onClick={() => setsidebarOpen(!sidebarOpen)} className={`${sidebarOpen ? 'block' : 'hidden'} fixed z-20 inset-0 bg-black opacity-50 transition-opacity lg:hidden`}></div>
    
        <div className={`${sidebarOpen ? 'translate-x-0 ease-out' : '-translate-x-full ease-in'} fixed z-30 inset-y-0 left-0 w-64 transition duration-300 transform bg-gray-900 overflow-y-auto lg:translate-x-0 lg:static lg:inset-0`}>
                ...
                <div className="flex items-center">
                    <div className="relative">
                        ...
                        <div  onClick={() => setnotificationOpen(false)}
                            className={`${notificationOpen ? 'visible' : 'invisible'} fixed inset-0 h-full w-full z-10`} ></div>
    
                        <div className={`${notificationOpen ? 'visible' : 'invisible'} absolute right-0 mt-2 w-80 bg-white rounded-lg shadow-xl overflow-hidden z-10`}
                            >
                            <a href="#"
                    ...
                    <div className="relative">
                        ...
                        <div  onClick={() => setdropdownOpen(false)} className={`${dropdownOpen ? 'visible' : 'invisible'} fixed inset-0 h-full w-full z-10`}
                            ></div>
    
                        <div 
                            className={`${dropdownOpen ? 'visible' : 'invisible'} absolute right-0 mt-2 w-48 bg-white rounded-md overflow-hidden shadow-xl z-10`}
                            >
                            <a href="#"
